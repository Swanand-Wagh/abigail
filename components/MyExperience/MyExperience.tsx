            ...
            >
              <div className="w-full flex justify-between flex-none items-center h-min flex-nowrap overflow-visible p-0 relative">
                <div className="flex items-center flex-1 gap-2 h-min justify-start overflow-visible p-0 relative">
                  <div className="bg-dark-gray-4 border border-border-color rounded-lg flex float-none gap-[10px] h-min justify-center items-center overflow-visible p-[7px] relative w-min">
                  ...
                  <div className="flex float-none flex-nowrap items-start gap-[6px] h-min justify-center overflow-visible p-0 relative w-min">
                    <div className="gap-0 flex h-min justify-start overflow-visible items-start flex-col flex-nowrap">
                      ...
                      {/* Year displayed below the company name in mobile view */}
                      <div className="sm:hidden flex-none h-auto relative whitespace-pre w-auto flex flex-col justify-start flex-shrink-0">
                        <h3 className="text-light-gray-4 font-bold text-lg">
                          {exp.year}
                        </h3>
                      </div>
                    ...
                    <div className="hidden sm:block bg-dark-gray-2 border border-dark-gray-3 flex-none items-center justify-start flex-nowrap gap-[10px] h-min overflow-visible p-[4px_10px] relative w-min rounded-3xl">
                      <div className="flex-none h-auto relative whitespace-pre w-auto flex flex-col justify-start flex-shrink-0">
                ...
                {/* Default year position, hidden on small screens */}
                <div className="hidden sm:flex flex-nowrap gap-[10px] h-min overflow-visible p-0 w-min items-center flex-none whitespace-pre">
